...
module "notejam_vpc" {
  ...
  private_subnets                      = [module.mod_subnet_addr.network_cidr_blocks["Private Subnet 1"], module.mod_subnet_addr.network_cidr_blocks["Private Subnet 3"]]
  ...
  public_subnet_tags = {
    ...
    "kubernetes.io/cluster/notejam" = "shared"
